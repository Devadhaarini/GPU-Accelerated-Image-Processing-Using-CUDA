...
## Technologies Used
CUDA Toolkit C++ OpenCV Library NVIDIA GPU Linux / Google Colab CUDA Environment

## Project Structure:
CUDA-Image-Processing-Benchmark/ │ ├── main.cu ├── Makefile ├── run.sh ├── README.md ├── images/ │ └── input.jpg └── outputs/ ├── grayscale.jpg ├── blur.jpg ├── sharpen.jpg └── edge.jpg
...
## Output:
<img width="546" height="660" alt="image" src="https://github.com/user-attachments/assets/c190f068-e12e-493d-a1d9-28e1c92b6fa5" />
